...
- When listing skipped items in the PR comment, the reason must accurately reflect WHY it was skipped. Never say "out of scope" for an open question — the real reason is that it requires team input that cannot be resolved by an implementation pass alone. Say that instead.
